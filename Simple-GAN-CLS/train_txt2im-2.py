...
def main_train():
    ...
    tl.files.exists_or_mkdir(model_dir + "samples/step1_gan-cls")
    tl.files.exists_or_mkdir(model_dir + "samples/step_pretrain_encoder")
    tl.files.exists_or_mkdir(model_dir + "checkpoint")
    ...
    sample_sentence = ["the flower shown has yellow anther red pistil and bright red petals."] * n + \
                      ...
                      ["tlhe flower has yellow petals and the center of it is brown."] * n + \
    ...
    start_epoch = 0
    graph_file = open(model_dir + "graph.txt","a")
    #print (n_batch_epoch)
    #exit()
    ...
    for epoch in range(start_epoch, n_epoch+1):
        ...
        if (epoch + 1) % print_freq == 0:
            ...
            save_images(img_gen, [ni, ni], model_dir + 'samples/step1_gan-cls/train_{:02d}.png'.format(epoch))
